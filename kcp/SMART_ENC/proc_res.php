...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body oncontextmenu="return false;" ondragstart="return false;" onselectstart="return false;">
        <form name="form_auth" method="post">
            <?= $sbParam ?>
			<input type="hidden" name="res_username" value="<?=$res_username?>">
			<input type="hidden" name="res_hphone" value="<?=$res_hphone?>">
			<input type="hidden" name="res_birthday" value="<?=$res_birthday?>">
        </form>
    </body>
</html>
