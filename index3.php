...
<form name="form_auth" method="post" action="/api/boost-us-proc.php" class="modal-boost-us__form">
    ...
    <input type="text" name="birthday" value="19810518">


    <div class="modal-boost-us__box modal-boost-us__name">
        <span>이름</span>
        <input type="text" name="name" readonly value="나나나">
    </div>
    <div class="modal-boost-us__box">
        <span>휴대전화</span>
        <div>
            <input type="text" name="comm_id" value="KTF">
            <input type="text" name="hphone" readonly value="00000000000">
    ...
    <input type="text" name="agree1" value="Y">
    <input type="text" name="agree1_ver" value="1.0">
    <input type="text" name="agree2" value="Y">
    <input type="text" name="agree2_ver" value="1.0">
