<?php
    ...
    $g_conf_Ret_URL      = "http://localhost/test/proc_req.php";
    ...
    $g_conf_gw_url       = "https://testcert.kcp.co.kr/kcp_cert/cert_view.jsp";		// https://cert.kcp.co.kr/kcp_cert/cert_view.jsp
